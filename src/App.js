...
export default function App() {
  ...
  const img1 = "/game1.png";
  const img2 = "/game2.png";
    ...
    <div className="app-root">
      <header className="site-header">
        <div className="header-inner">
          <div className="brand">
            <span className="brand-text">THE PYRAMID NEXUS</span>
          </div>
            ...
            <div className="levels-grid" id="games">
              ...
              <div className="lower-row">
                ...
                <div className="mini-card">
                  ...
                  <div className="mini-body">
                    <h4>Synapse Lab</h4>
                    <p className="muted small">Optimize signal flow.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="site-footer">
        <div>© {new Date().getFullYear()} PYRAMIND</div>
      </footer>
    </div>
  );
}
